...
public class RenZhengThreeModelImpl implements RenZhengThreeModel {
    @Override
    public void submit(List<String> content, DynamicContentFragment.DynamicType type, onLoadDateSingleListener listener) {
    ...
    private void upService(String content, onLoadDateSingleListener listener) {
        ...
        ObservableUtils.parser(observable, new ObservableUtils.Callback<BaseBean>() {
            ...
            public void onSuccess(BaseBean o) {
                listener.onSuccess(o, DataType.DATA_ZERO);
            }
