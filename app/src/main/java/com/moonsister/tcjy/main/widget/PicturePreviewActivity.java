...
public class PicturePreviewActivity extends Activity {
    ...
    private void initView() {
        ...
        this.mUseOrigin = new PicturePreviewActivity.CheckButton(this.findViewById(R.id.origin_check), R.drawable.rc_origin_check_nor, R.mipmap.rc_origin_check_sel);
