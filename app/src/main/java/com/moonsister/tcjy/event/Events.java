...
public class Events<T> {
    ...
    public enum EventEnum {
        ...
        SWITCH_ITEM, BUY_VIP_SUCCESS, MONEY_CHANGE, GET_IM_SERVICE_KEY, RenZhengThreeActivity_res_change, CLICK_ENGAGEMENT_SUCCESS, CLICK_ENGAGEMENT_LEVEL_NOT, REN_ZHENG_SUCCESS, EM_SEND_CMD,
    }
