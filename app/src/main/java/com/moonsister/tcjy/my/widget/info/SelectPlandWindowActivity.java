 ...
 */
public class SelectPlandWindowActivity extends Activity implements OnClickListener,
    ...
    protected void initProvinceDatas() {
        ...
        AssetManager asset = SelectPlandWindowActivity.this.getAssets();
        try {
...
//                sendRx(mCurrentProviceName, mCurrentCityName, mCurrentDistrictName);
    ...
    private void sendRx(String mCurrentProviceName, String mCurrentCityName, String mCurrentDistrictName) {
        Events<String> events = new Events<String>();
        events.what = Events.EventEnum.SELECT_PLAND_DATA;
        events.message = mCurrentProviceName + "." + mCurrentCityName + "." + mCurrentDistrictName;
