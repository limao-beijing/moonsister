package com.moonsister.tcjy.widget.wheelview;
...
public class WheelView extends View {
    ...
    public int ADDITIONAL_ITEM_HEIGHT;// change 55
    public int CUSTOMER_TEXT_SIZE;
    public boolean SET_TEXT_SIZE = false;
    /**
     * Text size
     */
     ...
     */
    // private static final int DEF_VISIBLE_ITEMS = 3; before
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            ...
            if (SET_TEXT_SIZE) {
                valuePaint.setTextSize(CUSTOMER_TEXT_SIZE);
            } else {
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        // initResourcesIfNecessary();//change
