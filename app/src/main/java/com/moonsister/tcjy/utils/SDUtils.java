...
//			Log.e("CommonUtil:getSDCardPath", e.toString());
	...
	public static String getRootFile(Context context) {
		...
		String rootPath = PrefUtils.getString(ConfigUtils.getInstance().getApplicationContext(),
				flagRootPath, null);
		if (rootPath != null) {
		...
		String packageName = context.getPackageName().substring(context.getPackageName().lastIndexOf(".") + 1);
		String sdPath = getSDPath() + File.separator+ packageName + File.separator;
		if (sdPath != null) {
			...
			PrefUtils.setString(context, flagRootPath, file
