...
public class PermissionsManager {
   ...
   *
   * @param activity the Activity necessary to request and check .
   * @param action   the PermissionsResultAction used to notify you of permissiopermissionsns being accepted.
   */
  @SuppressWarnings("unused")
