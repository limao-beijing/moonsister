...
//                .findViewById(Window.ID_ANDROID_CONTENT);
     ...
     * 进度改变
     */
    public interface OnProgressChangeListenter {
        void onChange(JCVideoPlayer player, int progress, int secProgress, int currentTime, int totalTime);
    }

    public OnProgressChangeListenter mProgressChangeListenter;

    public void setOnProgressChangeListenter(OnProgressChangeListenter mProgressChangeListenter) {
        this.mProgressChangeListenter = mProgressChangeListenter;
    }
    ...
    public void setProgressAndTime(int progress, int secProgress, int currentTime, int totalTime) {
        if (mProgressChangeListenter != null && mCurrentTime != currentTime / 1000) {
            mCurrentTime = currentTime / 1000;
            mProgressChangeListenter.onChange(this, progress, secProgress, mCurrentTime, totalTime);
        }
