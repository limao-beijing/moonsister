...
import static com.moonsister.tool.R.id.imageView;
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (convertView == null) {
                ...
                holder.imageView = (com.hickey.tool.activity.video.RecyclingImageView) convertView.findViewById(imageView);
        ...
        class ViewHolder {
            com.hickey.tool.activity.video.RecyclingImageView imageView;
            ImageView icon;
            TextView tvDur;
            TextView tvSize;
        }
